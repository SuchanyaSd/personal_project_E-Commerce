...
//    const [organization, setOrganization] = useState('Ingeniux');
//    const [workPhone, setWorkPhone] = useState('(509)-123-4567');
//    const [mobilePhone, setMobilePhone] = useState('(509)-123-4567');
//    const [email, setEmail] = useState('admin@ingeniux.com');

//    const handleSave = () => {
//       // Implement save logic here
//       console.log('Profile saved:', { name, title, organization, workPhone, mobilePhone, email });
//    };
...
//                <button className="mr-2 text-gray-600 hover:text-gray-800">Cancel</button>
//                <button
//                   onClick={handleSave}
